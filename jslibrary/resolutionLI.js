...
$(document).ready(function() {
	...
	var tabulka = document.getElementById("animLI");
	 ...
	 if(action==false){		
	  action=true;//zapoceni akce 		
  		...
  		time=setTimeout(function(){
  			...
  			time=setTimeout(function(){
  				firstKlauzul.innerHTML="{<span class="+red+">¬q</span>,<span class="+green+">¬p</span>}";
				...
				time=setTimeout(function(){
					...
					linearRezolution(tabulka,klauzuls,rowsOfKlauzuls,0,5,"{<span class="+green+">¬p</span>,<span class="+red+">q</span>}",0,1,"{<span class="+red+">¬p</span>}",timeOfSteps*5);
									
									time=setTimeout(function(){
										//komplexni animace jedne rezoluce
										linearRezolution(tabulka,klauzuls,rowsOfKlauzuls,2,4,"{<span class="+green+">¬r</span>,<span class="+red+">p</span>}",0,null,"{<span class="+red+">¬r</span>}",timeOfSteps*5);
										time=setTimeout(function(){
											//komplexni animace jedne rezoluce
											linearRezolution(tabulka,klauzuls,rowsOfKlauzuls,4,3,"{<span class="+red+">r</span>}",0,0,"<span class="+red+">□</span>",timeOfSteps*5);
 				
  													//vlozeni vetvi
  													time=setTimeout(function(){
								  						colored(tabulka.rows[4].cells[0].getElementsByTagName("span")[0],olderVariables);
								  						colored(tabulka.rows[4].cells[2].getElementsByTagName("span")[0],olderVariables);
  														variableRightRezolution (tabulka,6,0,"<span>□</span>"); 
  														action=false;
  														animated=true;
