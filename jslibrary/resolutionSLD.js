...
$(document).ready(function() {
	...
	var tabulka = document.getElementById("animSLD");
  		...
  		time=setTimeout(function(){
  			...
  			time=setTimeout(function(){
				...
				time=setTimeout(function(){
					...
					linearRezolution(tabulka,klauzuls,rowsOfKlauzuls,0,5,"[<span class="+red+">q</span>,<span class="+green+">¬p</span>]",1,1,"[<span class="+red+">¬p</span>,<span class="+green+">¬p</span>]",timeOfSteps*5);
									
									time=setTimeout(function(){
										//komplexni animace jedne rezoluce
										linearRezolution(tabulka,klauzuls,rowsOfKlauzuls,2,4,"[<span class="+red+">p</span>,<span class="+green+">¬r</span>]",1,1,"[<span class="+red+">¬r</span>,<span class="+green+">¬p</span>]",timeOfSteps*5);
									
										time=setTimeout(function(){
											//komplexni animace jedne rezoluce
											linearRezolution(tabulka,klauzuls,rowsOfKlauzuls,4,3,"[<span class="+red+">r</span>]",null,1,"[<span class="+red+">¬p</span>]",timeOfSteps*5);
